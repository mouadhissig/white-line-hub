...
const Donation = () => {
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4">
      ...
      <Link
        to="/"
        className="absolute top-6 left-6 inline-flex items-center gap-2 text-foreground/70 hover:text-foreground transition-colors duration-300"
      >
      ...
      <Link
        to="/"
        className="mt-10 inline-flex items-center justify-center px-8 py-4 text-lg font-medium text-background bg-foreground rounded-none hover:bg-foreground/90 transition-all duration-300"
      >
        Retour à l'accueil
