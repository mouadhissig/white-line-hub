ALTER TABLE public.survey_submissions ADD COLUMN IF NOT EXISTS device_id text;
CREATE INDEX IF NOT EXISTS idx_survey_submissions_device_id ON public.survey_submissions(device_id);
